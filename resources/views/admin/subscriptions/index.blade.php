...
<div class="page-header d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('subscriptions.create') }}" class="btn btn-light"><i class="bi bi-plus-lg me-1"></i>New Plan</a>
</div>

<div class="mb-3">
    <a href="{{ route('subscriptions.subscribers') }}" class="btn btn-outline-light btn-sm text-dark border"><i class="bi bi-people me-1"></i>View Subscribers</a>
</div>
    ...
    <div class="col-md-4">
        <div class="stat-card p-4 bg-white h-100">
            ...
            <div class="mt-3 d-flex gap-2">
                <a href="{{ route('subscriptions.edit', $plan) }}" class="btn btn-sm btn-outline-primary">Edit</a>
                <form action="{{ route('subscriptions.destroy', $plan) }}" method="POST" onsubmit="return confirm('Delete plan?')">
                    @csrf @method('DELETE')
